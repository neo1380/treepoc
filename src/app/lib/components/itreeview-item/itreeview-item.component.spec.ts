...
import { TreeviewItemComponent } from './itreeview-item.component';
import { ITreeviewItem } from '../../models/itreeview-item';
import { fakeItemTemplate } from './itreeview-item-template.spec';
...
const testTemplate = fakeItemTemplate
  + '<itreeview-item [item]="item" [template]="itemTemplate" (checkedChange)="checkedChange($event)"></itreeview-item>';
...
describe('TreeviewItemComponent', () => {
  ...
  describe('item', () => {
    it('should not have element with class "treeview-item" if no item provided', () => {
      const fixture = createTestComponent('<itreeview-item></itreeview-item>');
    ...
    it('should have element with class "treeview-item" if binding item', () => {
      fakeData.item = new ITreeviewItem({ text: '1', value: 1 });
      const fixture = createTestComponent('<itreeview-item [item]="item"></itreeview-item>');
      fixture.detectChanges();
      const element = fixture.debugElement.query(By.css('.treeview-item'));
  ...
  describe('template', () => {
    ...
    beforeEach(() => {
      fakeData.item = new ITreeviewItem({
        text: 'Parent 1',
        value: 1,
        checked: true,
        collapsed: false,
