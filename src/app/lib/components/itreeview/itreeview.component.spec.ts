...
import { TreeviewComponent } from './itreeview.component';
...
describe('TreeviewComponent', () => {
  const baseTemplate = '<itreeview [items]="items" [config]="config" (selectedChange)="selectedChange($event)"></itreeview>';
  ...
  describe('no data binding', () => {
    ...
    beforeEach(fakeAsync(() => {
      fixture = createTestComponent('<itreeview></itreeview>');
      fixture.detectChanges();
      tick();
    }));
  ...
  describe('null data binding', () => {
    ...
    beforeEach(fakeAsync(() => {
      fakeData.items = null;
      fixture = createTestComponent('<itreeview [items]="items"></itreeview>');
      fixture.detectChanges();
      tick();
    }));
  ...
  describe('all items are collapsed but config has hasCollapseExpand=false', () => {
    ...
    beforeEach(fakeAsync(() => {
      fakeData.config = ITreeviewConfig.create({
        hasCollapseExpand: true
      });
      fakeData.items = [new ITreeviewItem({ text: '1', value: 1, collapsed: true })];
      fixture = createTestComponent('<itreeview [config]="config" [items]="items"></itreeview>');
      fixture.detectChanges();
      tick();
    }));
  ...
  describe('config', () => {
    ...
    describe('hasAllCheckBox', () => {
      ...
      it('should display checkbox "All" if value is true', () => {
        ...
        const fixture = createTestComponent('<itreeview [config]="config" [items]="items"></itreeview>');
        fixture.detectChanges();
    ...
    describe('decoupleChildFromParent with false value', () => {
      ...
      beforeEach(fakeAsync(() => {
        fakeData.items = [new ITreeviewItem({ text: '1', value: 1, children: [{ text: '11', value: 11 }] })];
        fakeData.config = ITreeviewConfig.create({
          hasAllCheckBox: false,
          hasCollapseExpand: false,
          hasFilter: false,
    ...
    describe('divider', () => {
      ...
      it('should display divider with default config', () => {
        fakeData.config = new ITreeviewConfig();
        const fixture = createTestComponent('<itreeview [config]="config" [items]="items"></itreeview>');
        fixture.detectChanges();
...
<itreeview [items]="items" [itemTemplate]="itemTemplate"></itreeview>`;
