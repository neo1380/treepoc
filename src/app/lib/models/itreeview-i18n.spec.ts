...
import { ITreeviewItem, TreeviewSelection } from './itreeview-item';
import { DefaultTreeviewI18n, TreeviewI18n } from './itreeview-i18n';
...
describe('DefaultTreeviewI18n', () => {
  ...
  describe('getText', () => {
    ...
    it('should return "Select options" if list of checked items is empty', () => {
      const selection: TreeviewSelection = {
        checkedItems: [],
        uncheckedItems: [new ITreeviewItem({ text: 'Item 1', value: undefined })]
      };
    ...
    it('should return text of first checked item if length of checked items is 1', () => {
      const selection: TreeviewSelection = {
        checkedItems: [new ITreeviewItem({ text: 'Item 1', value: undefined })],
        uncheckedItems: [new ITreeviewItem({ text: 'Item 2', value: undefined })]
      };
    ...
    it('should return "2 options selected" if length of checked items is 2', () => {
      const selection: TreeviewSelection = {
        checkedItems: [
          new ITreeviewItem({ text: 'Item 1', value: undefined }),
          new ITreeviewItem({ text: 'Item 2', value: undefined })
        ],
        uncheckedItems: [new ITreeviewItem({ text: 'Item 3', value: undefined })]
      };
