...
import { TreeviewHelper } from './itreeview-helper';

const rootNoChildren = new ITreeviewItem({
  text: '1',
  value: 1
});
const rootHasChildren = new ITreeviewItem({
  text: '1',
  value: 1,
  checked: false,
  children: [
...
const fakeItem = new ITreeviewItem({
  text: '1',
  value: 1
});
